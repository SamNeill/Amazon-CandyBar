...
import candybar.lib.utils.AmazonIAPChecker;
...
public abstract class CandyBarApplication extends Application {
    ...
    public boolean isAmazonBillingEnabled() {
        return AmazonIAPChecker.isAmazonIAPAvailable(this) && 
               getResources().getBoolean(R.bool.enable_amazon_billing);
    }

    public boolean isPremiumRequestEnabled() {
        return getResources().getBoolean(R.bool.enable_premium_request);
    }
    
    public boolean isDonationEnabled() {
        return getResources().getBoolean(R.bool.enable_donation);
    }
    
    public String[] getPremiumRequestProductIds() {
        return getResources().getStringArray(R.array.premium_request_product_ids);
    }

    public int[] getPremiumRequestCounts() {
        return getResources().getIntArray(R.array.premium_request_counts);
    }

    public String[] getPremiumRequestPrices() {
        return getResources().getStringArray(R.array.premium_request_prices);
    }

    public String[] getDonationProductsId() {
        return getResources().getStringArray(R.array.donation_product_ids);
    }
    
    public String[] getDonationProductsPrices() {
        return getResources().getStringArray(R.array.donation_product_prices);
    }

    public String[] getDonationProductNames() {
        return getResources().getStringArray(R.array.donation_product_names);
    }
}
